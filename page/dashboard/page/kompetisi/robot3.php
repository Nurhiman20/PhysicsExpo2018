...
<form action="" method="post">
  ...
  <button type="submit" name="sekolah" class="btn btn-primary btn-block">Berikutnya</button>
</form>
<?php endif; ?>

<?php if (isset($_POST['sekolah'])) :
	...
	?>
<h2>Identitas Ketua Tim</h2>
<form action="" method="post">
	<input type="hidden" name='nama_sek' value="<?= $nama_sek; ?>">
	<div class="form-group">
	    <label for="nama_ket">Nama Ketua Tim</label>
	...
	<div class="form-group">
	  <label for="foto_ket">Upload Pas Foto (max. 2 MB)</label>
	  <input type="file" class="form-control-file" name="foto_ket" id="foto_ket">
	</div>
	<button type="submit" name="ketua" class="btn btn-primary btn-block">Berikutnya</button>
</form>
<?php endif; ?>

<?php if (isset($_POST['ketua'])) :
	$nama_sek = $_POST['nama_sek'];
	$query2 = "SELECT id_sek FROM sekolah WHERE nama_sek = '$nama_sek'";
	$result = mysqli_query($conn, $query2);
	$id_sek = mysqli_fetch_assoc($result);
	$id = $id_sek['id_sek'];
	...
	$query3 = "INSERT INTO peserta
				VALUES
				('','$id','1','$nama_ket','$alamat_ket','$telp_ket','$wa_ket','$email_ket','','')
			 ";
	mysqli_query($conn, $query3);
?>
<h2>Identitas Anggota I</h2>
<form action="" method="post">
	<input type="hidden" name="nama_sek2" value="<?= $nama_sek; ?>">
	<div class="form-group">
	...
	<div class="form-group">
	  <label for="foto_ang1">Upload Pas Foto (max. 2 MB)</label>
	  <input type="file" class="form-control-file" name="foto_ang1" id="foto_ang1">
	</div>
	<button type="submit" name="ang1" class="btn btn-primary btn-block">Berikutnya</button>
</form>
<?php endif; ?>

<?php if (isset($_POST['ang1'])) :
	$nama_sek = $_POST['nama_sek2'];
	$query2 = "SELECT id_sek FROM sekolah WHERE nama_sek = '$nama_sek'";
	$result = mysqli_query($conn, $query2);
	$id_sek = mysqli_fetch_assoc($result);
	$id = $id_sek['id_sek'];
	...
	$query4 = "INSERT INTO peserta
				VALUES
				('','$id','1','$nama_ang1','$alamat_ang1','$telp_ang1','$wa_ang1','$email_ang1','','')
			 ";
...
<form action="" method="post">
	<input type="hidden" name="nama_sek3" value="<?= $nama_sek; ?>">
	<div class="form-group">
	...
	<div class="form-group">
	  <label for="foto_ang2">Upload Pas Foto (max. 2 MB)</label>
	  <input type="file" class="form-control-file" name="foto_ang2" id="foto_ang2">
	</div>
	<button type="submit" name="ang2" class="btn btn-primary btn-block">Berikutnya</button>
</form>
<?php endif; ?>

<?php if (isset($_POST['ang2'])) :
	$nama_sek = $_POST['nama_sek3'];
	$query2 = "SELECT id_sek FROM sekolah WHERE nama_sek = '$nama_sek'";
	$result = mysqli_query($conn, $query2);
	$id_sek = mysqli_fetch_assoc($result);
	$id = $id_sek['id_sek'];
	...
	$query5 = "INSERT INTO peserta
				VALUES
				('','$id','1','$nama_ang2','$alamat_ang2','$telp_ang2','$wa_ang2','$email_ang2','','')
			 ";
...
<form action="" method="post">
	...
	<div class="form-group">
	    ...
	    <input type="text" class="form-control" name="wa_pen" id="pen">
	</div>
	<div class="form-group">
	...
	<div class="form-group">
	  <label for="foto_pen">Upload Pas Foto (max. 2 MB)</label>
	  <input type="file" class="form-control-file" name="foto_pen" id="foto_pen">
	</div>	
	<button type="submit" name="tim" class="btn btn-primary btn-block">Submit</button>
</form>
<?php endif; ?>