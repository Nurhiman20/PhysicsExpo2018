...
if (isset($_POST['jf2'])) {
	...
	if (!isset($gagal)) {
		...
		$query_pes = "INSERT INTO peserta
					VALUES
					('','$nama_sek','2','$nama_pes','$alamat_pes','$telp_pes','$wa_pes','$email_pes','$foto_pes','$nama_pen','$id_transaksi')
				 ";
		...
		$query_part = "INSERT INTO partisipasi
					VALUES
					('$id_partisipasi','$id_transaksi','$nama_akun','Jawara Fisika','Belum Lunas','','2','$tanggal')
				 ";
...
<h1 class="text-center">Jawara Fisika</h1>
<?php if (isset($sukses)): ?>
...
<form action="" method="post" enctype="multipart/form-data">
	...
	<div class="form-group">
	  <label for="foto_pes">Upload Pas Foto (max. 2 MB)</label>
	...
	<button type="submit" name="jf2" class="btn btn-primary btn-block">Submit</button>
</form>