...
if (isset($_POST['robot2'])) {
	...
	if (!$foto_ket || !$foto_ang1 || !$foto_ang2) {
		$gagal = true;
	}
	...
	if (!isset($gagal)) {
		...
		$query_ket = "INSERT INTO peserta
					VALUES
					('','$nama_sek','1','$nama_ket','$alamat_ket','$telp_ket','$wa_ket','$email_ket','$foto_ket','$nama_pen','$id_transaksi')
				 ";
		$query_ang1 = "INSERT INTO peserta
					VALUES
					('','$nama_sek','1','$nama_ang1','$alamat_ang1','$telp_ang1','$wa_ang1','$email_ang1','$foto_ang1','$nama_pen','$id_transaksi')
				 ";
		$query_ang2 = "INSERT INTO peserta
					VALUES
					('','$nama_sek','1','$nama_ang2','$alamat_ang2','$telp_ang2','$wa_ang2','$email_ang2','$foto_ang2','$nama_pen','$id_transaksi')
				 ";
		...
		$query_tim = "INSERT INTO tim
					VALUES
					('','$nama_tim','$nama_ket','$nama_ang1','$nama_ang2','$nama_pen','$id_transaksi')
				 ";
		...
		$query_part = "INSERT INTO partisipasi
					VALUES
					('$id_partisipasi','$id_transaksi','$nama_akun','Robotic Challenge','Belum Lunas','','1','$tanggal')
				 ";
...
<h1 class="text-center">Robotic Challenge</h1>
<?php if (isset($sukses)): ?>
...
<form action="" method="post" enctype="multipart/form-data">
	...
	<button type="submit" name="robot2" class="btn btn-primary btn-block">Submit</button>
</form>