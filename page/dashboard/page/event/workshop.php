...
if (isset($_POST['workshop2'])) {
	...
	$query_pes = "INSERT INTO peserta
				VALUES
				('','$nama_sek','4','$nama_pes','$alamat_pes','$telp_pes','$wa_pes','$email_pes','','','$id_transaksi')
			 ";
	...
	$id_partisipasi = time();
		...
		$query_part = "INSERT INTO partisipasi
					VALUES
					('$id_partisipasi','$id_transaksi','$nama_akun','Workshop','Belum Lunas','','4','$tanggal')
				 ";
...
<form action="" method="post" enctype="multipart/form-data">
	...
	<button type="submit" name="workshop2" class="btn btn-primary btn-block">Submit</button>
</form>