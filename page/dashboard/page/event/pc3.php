...
if (isset($_POST['pc32'])) {
	...
	// data peserta 4
	$nama_pes4 = htmlspecialchars($_POST['nama_pes4']);
	$alamat_pes4 = htmlspecialchars($_POST['alamat_pes4']);
	$telp_pes4 = htmlspecialchars($_POST['telp_pes4']);
	$wa_pes4 = htmlspecialchars($_POST['wa_pes4']);
	$email_pes4 = htmlspecialchars($_POST['email_pes4']);

	// data peserta 5
	$nama_pes5 = htmlspecialchars($_POST['nama_pes5']);
	$alamat_pes5 = htmlspecialchars($_POST['alamat_pes5']);
	$telp_pes5 = htmlspecialchars($_POST['telp_pes5']);
	$wa_pes5 = htmlspecialchars($_POST['wa_pes5']);
	$email_pes5 = htmlspecialchars($_POST['email_pes5']);
	...
	$query_pes = "INSERT INTO peserta
				VALUES
				('','$nama_sek','8','$nama_pes','$alamat_pes','$telp_pes','$wa_pes','$email_pes','','$nama_pen','$id_transaksi')
			 ";

	// query tabel peserta 2
	$query_pes2 = "INSERT INTO peserta
				VALUES
				('','$nama_sek','8','$nama_pes2','$alamat_pes2','$telp_pes2','$wa_pes2','$email_pes2','','$nama_pen','$id_transaksi')
			 ";

	// query tabel peserta 3
	$query_pes3 = "INSERT INTO peserta
				VALUES
				('','$nama_sek','8','$nama_pes3','$alamat_pes3','$telp_pes3','$wa_pes3','$email_pes3','','$nama_pen','$id_transaksi')
			 ";

	// query tabel peserta 4
	$query_pes4 = "INSERT INTO peserta
				VALUES
				('','$nama_sek','8','$nama_pes4','$alamat_pes4','$telp_pes4','$wa_pes4','$email_pes4','','$nama_pen','$id_transaksi')
			 ";

	// query tabel peserta 5
	$query_pes5 = "INSERT INTO peserta
				VALUES
				('','$nama_sek','8','$nama_pes5','$alamat_pes5','$telp_pes5','$wa_pes5','$email_pes5','','$nama_pen','$id_transaksi')
			 ";
	...
	// query tabel tim 2
	$query_tim2 = "INSERT INTO tim
				VALUES
				('','','$nama_pes4','$nama_pes5','','$nama_pen','$id_transaksi')
			 ";
	...
	$query_part = "INSERT INTO partisipasi
				VALUES
				('$id_partisipasi','$id_transaksi','$nama_akun','Physics Camp (Paket 3)','Belum Lunas','','8','$tanggal')
			 ";
	...
	mysqli_query($conn, $query_pes4);
	mysqli_query($conn, $query_pes5);
	mysqli_query($conn, $query_pen);
	mysqli_query($conn, $query_tim);
	mysqli_query($conn, $query_tim2);
...
<h1 class="text-center">Physics Camp (Paket 3)</h1>
<?php if (isset($sukses)): ?>
...
<form action="" method="post">
	...
	<div class="form-group">
	    <label for="email_pes5">Email</label>
	    <input type="email" class="form-control" name="email_pes5" id="email_pes5">
	</div><br>

	<h2>Identitas Peserta IV</h2>
	<div class="form-group">
	    <label for="nama_pes4">Nama</label>
	    <input type="text" class="form-control" name="nama_pes4" id="nama_pes4">
	</div>
	<div class="form-group">
	    <label for="alamat_pes4">Alamat Lengkap</label>
	    <input type="text" class="form-control" name="alamat_pes4" id="alamat_pes4">
	</div>
	<div class="form-group">
	    <label for="telp_pes4">Nomor Telepon</label>
	    <input type="text" class="form-control" name="telp_pes4" id="telp_pes4">
	</div>
	<div class="form-group">
	    <label for="wa_pes4">Nomor WA</label>
	    <input type="text" class="form-control" name="wa_pes4" id="wa_pes4">
	</div>
	<div class="form-group">
	    <label for="email_pes4">Email</label>
	    <input type="email" class="form-control" name="email_pes4" id="email_pes4">
	</div><br>

	<h2>Identitas Peserta V</h2>
	<div class="form-group">
	    <label for="nama_pes5">Nama</label>
	    <input type="text" class="form-control" name="nama_pes5" id="nama_pes5">
	</div>
	<div class="form-group">
	    <label for="alamat_pes5">Alamat Lengkap</label>
	    <input type="text" class="form-control" name="alamat_pes5" id="alamat_pes5">
	</div>
	<div class="form-group">
	    <label for="telp_pes5">Nomor Telepon</label>
	    <input type="text" class="form-control" name="telp_pes5" id="telp_pes5">
	</div>
	<div class="form-group">
	    <label for="wa_pes5">Nomor WA</label>
	    <input type="text" class="form-control" name="wa_pes5" id="wa_pes5">
	</div>
	<div class="form-group">
	...
	<button type="submit" name="pc32" class="btn btn-primary btn-block">Submit</button>
</form>