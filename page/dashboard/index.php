...
$partisipasi = query("SELECT * FROM partisipasi INNER JOIN kompetisi ON partisipasi.nama_event = kompetisi.nama_event WHERE id_transaksi = '$id_transaksi'
    ");
?>
        ...
        <nav class="navbar-default navbar-side" role="navigation" style="background-color: #040d1a">
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a href="?page=data"><i class="fa fa-3x"></i> Data Peserta</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="?page=tiket"><i class="fa fa-3x"></i> E-Ticket</a>
                    </li>
                ...
                <div class="row">
                    ...
                    if (isset($_GET['page'])) {
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <!-- <td><a href="hapus.php?id=<?= $row['id_partisipasi']; ?>" onclick="return confirm('Apakah anda akan menghapus data ini?');">Hapus</a></td> -->
                                </tr>
                            <?php endforeach; ?>
                            </tbody>
                        </table>
                        ...
                        <div class="alert alert-info text-center" role="alert">
                            ...
                            <br>
                            7604-01-01239353-7 a.n. Bella Suci Yanti
                            <br>
