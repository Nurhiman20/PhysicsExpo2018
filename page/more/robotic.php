...
<head>
	...
	<title>Robotic Competition - PE2018</title>
</head>
<body>
	...
	<section class="bukupandu" id="bukupandu">
		<div class="container">
			<div class="row">
				<div class="col-sm-6">
					<img src="assets/img/robotic.png" alt="Logo Robotic" class="gambar">
				</div>
				<div class="col-sm-6">
					<div class="deskripsi">
						<p>Robotic challenge adalah rangkaian kegiatan yang bertujuan untuk mengenalkan dan membangun jiwa kompetitif siswa SMA yang berminat pada bidang robotika dan instrumentasi. Rangkaian yang diselenggarakan meliputi  pelatihan robotika maze solver dan kontes robotic maze solver. Pada kegiatan pelatihan, siswa dilatih supaya mengenal bagian-bagian penting untuk merakit sebuah robot, hingga robot tersebut berfungsi sesuai dengan yang diharapkan (dalam hal ini robot yang digunakan adalah maze solver). Selain itu, peserta lomba diharapkan dapat memahami aplikasi fisika dalam bidang elektronika.</p>
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-6" id="timeline">
					...
					<img src="assets/img/timelineRobot.png" alt="Timeline" class="gambarTimeline">
				</div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4" id="kontak">
            ...
            Narahubung Robotic : 085694919400 (Alifa) <br>
